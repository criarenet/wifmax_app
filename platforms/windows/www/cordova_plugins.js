...
module.exports = [
    ...
    {
        "id": "cordova-plugin-local-notifications-npm.LocalNotification.Proxy",
        "file": "plugins/cordova-plugin-local-notifications-npm/src/windows/LocalNotificationProxy.js",
        "pluginId": "cordova-plugin-local-notifications-npm",
        "merges": [
            ""
        ]
    ...
    {
        "id": "cordova-plugin-local-notifications-npm.LocalNotification.Proxy.Core",
        "file": "plugins/cordova-plugin-local-notifications-npm/src/windows/LocalNotificationCore.js",
        "pluginId": "cordova-plugin-local-notifications-npm",
        "merges": [
            ""
        ]
    ...
    {
        "id": "cordova-plugin-local-notifications-npm.LocalNotification.Proxy.Util",
        "file": "plugins/cordova-plugin-local-notifications-npm/src/windows/LocalNotificationUtil.js",
        "pluginId": "cordova-plugin-local-notifications-npm",
        "merges": [
            ""
        ]
...
// TOP OF METADATA
{
    "cordova-common-registerusernotificationsettings-npm": "1.0.2",
